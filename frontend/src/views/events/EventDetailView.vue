...
import EventGroupPhaseAssignment from '@/components/domain/event/EventGroupPhaseAssignment.vue'
import BaseInputError from '@/components/ui/BaseInputError.vue'
import SubjectSearchSelect from '@/components/domain/subject/SubjectSearchSelect.vue'
import SearchableCheckboxGroup from '@/components/ui/SearchableCheckboxGroup.vue'
import EventGroupQuickAssignModal from '@/components/domain/event/EventGroupQuickAssignModal.vue'
import EventGroupRandomizerModal from '@/components/domain/event/EventGroupRandomizerModal.vue'
import ImagePreview from '@/components/ui/ImagePreview.vue'
import ImageUploadBox from '@/components/ui/ImageUploadBox.vue'
import EventMediaGallery from '@/components/domain/event/EventMediaGallery.vue'
import PhaseConfigMetadataModal from '@/components/domain/event/PhaseConfigMetadataModal.vue'
