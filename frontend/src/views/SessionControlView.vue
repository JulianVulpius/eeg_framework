...
kbd { background-color: #f8f9fa; border: 1px solid #d1d5db; border-radius: 3px; box-shadow: 0 1px 1px rgba(0,0,0,0.1); padding: 2px 6px; font-family: monospace; font-weight: bold; }
