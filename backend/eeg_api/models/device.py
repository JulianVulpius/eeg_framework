...
from .masterdata import Manufacturer, EEGChannel
...
class DeviceModel(models.Model):
    ...
    manufacturer = models.ForeignKey(Manufacturer, on_delete=models.SET_NULL, null=True, blank=True, related_name='device_models')
    category = models.ForeignKey(DeviceModelCategory, on_delete=models.SET_NULL, null=True, blank=True, related_name='device_models')
...
class DeviceInstance(AuditBaseModel):
    session = models.ForeignKey('eeg_api.Session', on_delete=models.CASCADE, related_name='device_instances')
    device_model = models.ForeignKey(DeviceModel, on_delete=models.PROTECT, related_name='instances')
    phase_config = models.ForeignKey('eeg_api.EventGroupPageGroupDevice', on_delete=models.PROTECT, related_name='instances')
